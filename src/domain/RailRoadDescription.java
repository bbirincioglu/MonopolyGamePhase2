...
public class RailRoadDescription {
	...
	public RailRoadDescription(ArrayList<Integer> rents, int mortgageValue) {
		super();
		this.rents = rents;
		this.mortgageValue = mortgageValue;
	}
	
	public static RailRoadDescription fromJSON(JSONObject descriptionAsJSON){
		RailRoadDescription desc= null;
		...
		desc=new RailRoadDescription(rents, mortgageValue);
